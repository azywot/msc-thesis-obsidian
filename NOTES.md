...
- from the initial results we see that the collaboration with agents works the best for GAIA L1 questions (easy ones) → maybe we could use Self-Hinting LM Enhance RL to fine tune the orchestrator to improve on L2/L3
